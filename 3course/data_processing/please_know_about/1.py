...
'''
    Кроме доступа к значениям через оператор индексации (ака квадратные скобки), pandas предоставляет ещё два аттрибута
    ...
    Оба аттрибута возвращают некоторые прокси-объекты, к которым в свою очередь применяется оператор индексации:

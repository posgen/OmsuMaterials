...
void print_data_size(void)
{
    /*
        ...
        К слову, строка в языке С указывается в двойных кавычках и может включать в себя слэш-последовательности, которые влияют на вывод строки на экран. 
    ...
    */
    ...
    // Можно выйти из функции и указанием явного return без возращаемого значения. Обязательным не является и применяется в случаях сложного ветвления логики выполнения. 
    // Потому и закомментирована следующая строка. 
    // return;
}

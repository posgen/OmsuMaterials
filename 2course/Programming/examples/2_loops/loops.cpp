...
double sum_or_substract(double number1, double number2)
{
    ...
    /*
        ...
        В языке определены следующие операторы сравнения: ==, >, <, >=, <=, !=. (равенство, больше, меньше, больше или равно, меньше или равно, неравенство). Например, a != b, num1 == num2, num1 >= num2. 
        Данные операторы возращают 1, если условие выполняется и 0 в противоположном случае.
    ...
    */
    ...
    /*
        ...
        Проверка на сумму (number1 + number2) тогда принимает следующий вид:
            abs(nuber1 + number2 - 25.0) < 0.000001
        Здесь используем функция abs (из <cmath>) - вычисляет модуль действительного числа от своего аргумента. И теперь проверка означает:

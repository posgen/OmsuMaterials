...
int main()
{
    ...
    // заполним трёхмерный массив array3D случайными числами от -5 до 5 и вычислим среденее среди всех отличательных.
    for (i = 0; i < 10; i++) {
        for (j = 0; j < 10; j++) {
            for (k = 0; k < 10; k++) {
    ...
    if (negative_count > 0)
        printf("The average is %f", average / negative_count);
    else

...
FP003Array::Iterator::Iterator(const FP003Array::Iterator& other) :
    index{other.index}, arr_ref{other.arr_ref}
{}

FP003Array::Iterator& FP003Array::Iterator::operator=(const FP003Array::Iterator& other)
{
    index = other.index;
    arr_ref = other.arr_ref;
    return *this;
}
...
FP003Array::Iterator FP003Array::Iterator::operator++(int)
{
    FP003Array::Iterator tmp = *this;
    this->index++;
    return tmp;
}
...
bool FP003Array::Iterator::operator==(const Iterator& rhs)
{
    return index == rhs.index;
}
...
int& FP003Array::Iterator::operator[](int n)
{
    FP003Array::Iterator tmp = *this + n;
    return *tmp;
}

int FP003Array::Iterator::operator-(const Iterator& rhs)
{
...
FP003Array::Iterator FP003Array::Iterator::operator+(int n)
{
    FP003Array::Iterator tmp{*this};
    tmp.index += n;
    return tmp;
